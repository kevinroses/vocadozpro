...
const ApplePayIcon = () => {
    return (
        <span id="applepay_icon">
            <svg id="svg-text" viewBox="0 0 121.59 28.571" aria-hidden="true">
                <defs>
                    <style>
                        {`
                                    text {
            ...
            <svg id="svg-logo" viewBox="0 0 35 15" className="hidden">
                {/* Another Apple Logo SVG (Hidden) */}
            </svg>
        </span>
    )
}
